...
function buildOracleSystemPrompt(): string {
  return [
    "You are the oracle. Answer the user question concisely and directly.",
    "If information and/or context is missing, explain what else is needed rather than guessing.",
    "Use any attached files as authoritative context. Keep formatting minimal and markdown-compatible.",
  ].join(" ");
}
