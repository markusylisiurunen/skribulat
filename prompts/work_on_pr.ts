...
preparing the PR for merging based on the provided feedback.

Use any relevant AGENTS.md files in the repository to guide your actions. The environment is already
set up: the PR branch is checked out and up to date. You can begin immediately.

Be aware that the PR may have been open for some time and may contain many comments. Use all
comments as context, but address only those comments that have been specifically selected for you.
